...
/* harmony import */ var _xmldom_xmldom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28);
...
class Path {
  ...
  join(what) {
    return path_webpack__WEBPACK_IMPORTED_MODULE_0___default.a.join(this.directory, what);
  }
  /**
...
/* harmony import */ var _mapping__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17);
/* harmony import */ var _utils_replacements__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
...
exports.Underline = exports.Pane = exports.Mark = exports.Highlight = void 0;
__webpack_require__(96);
__webpack_require__(68);
var _svg = _interopRequireDefault(__webpack_require__(125));
var _events = _interopRequireDefault(__webpack_require__(126));
...
class Underline extends Highlight {
  ...
  render() {
    ...
    for (var i = 0, len = filtered.length; i < len; i++) {
      ...
      line.setAttribute('stroke-width', ((_this$attributes = this.attributes) === null || _this$attributes === void 0 ? void 0 : _this$attributes['stroke-width']) || 1);
      line.setAttribute('stroke-opacity', ((_this$attributes2 = this.attributes) === null || _this$attributes2 === void 0 ? void 0 : _this$attributes2['stroke-opacity']) || 0.3);
      line.setAttribute('stroke', ((_this$attributes3 = this.attributes) === null || _this$attributes3 === void 0 ? void 0 : _this$attributes3.stroke) || 'black'); //TODO: match text color?
...
exports.DOMParser = __webpack_require__(93).DOMParser
...
var src_contents = __webpack_require__(23);
...
class annotations_Annotation {
  ...
  update(data = {}, styles = {}) {
    ...
    if (styles !== null && styles !== void 0 && styles.stroke) {
      var _this$mark, _this$mark$attributes;

      if ((_this$mark = this.mark) !== null && _this$mark !== void 0 && (_this$mark$attributes = _this$mark.attributes) !== null && _this$mark$attributes !== void 0 && _this$mark$attributes.stroke) {
    ...
    if (styles !== null && styles !== void 0 && styles["stroke-opacity"]) {
      var _this$mark2, _this$mark2$attribute;

      if ((_this$mark2 = this.mark) !== null && _this$mark2 !== void 0 && (_this$mark2$attribute = _this$mark2.attributes) !== null && _this$mark2$attribute !== void 0 && _this$mark2$attribute["stroke-opacity"]) {
    ...
    if (styles !== null && styles !== void 0 && styles["stroke-width"]) {
      var _this$mark3, _this$mark3$attribute;

      if ((_this$mark3 = this.mark) !== null && _this$mark3 !== void 0 && (_this$mark3$attribute = _this$mark3.attributes) !== null && _this$mark3$attribute !== void 0 && _this$mark3$attribute["stroke-width"]) {
    ...
    if (styles !== null && styles !== void 0 && styles.fill) {
      var _this$mark4, _this$mark4$attribute;

      if ((_this$mark4 = this.mark) !== null && _this$mark4 !== void 0 && (_this$mark4$attribute = _this$mark4.attributes) !== null && _this$mark4$attribute !== void 0 && _this$mark4$attribute.fill) {
    ...
    if (styles !== null && styles !== void 0 && styles["fill-opacity"]) {
      var _this$mark5, _this$mark5$attribute;

      if ((_this$mark5 = this.mark) !== null && _this$mark5 !== void 0 && (_this$mark5$attribute = _this$mark5.attributes) !== null && _this$mark5$attribute !== void 0 && _this$mark5$attribute["fill-opacity"]) {
...
var iframe = __webpack_require__(45);

// EXTERNAL MODULE: ./src/managers/default/index.js + 3 modules
var managers_default = __webpack_require__(16);

// EXTERNAL MODULE: ./src/managers/continuous/index.js + 1 modules
var continuous = __webpack_require__(47);
...
/* harmony import */ var _utils_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var _epubcfi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
/* harmony import */ var _contents__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(23);
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1);
/* harmony import */ var _victorsoares96_marks_pane__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24);
/* harmony import */ var _victorsoares96_marks_pane__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_victorsoares96_marks_pane__WEBPACK_IMPORTED_MODULE_5__);
...
class IframeView {
  ...
  highlight(cfiRange, data = {}, cb, className = "epubjs-hl", styles = {}) {
    ...
    if (!this.pane) {
      this.pane = new _victorsoares96_marks_pane__WEBPACK_IMPORTED_MODULE_5__["Pane"](this.iframe, this.element);
    }

    let m = new _victorsoares96_marks_pane__WEBPACK_IMPORTED_MODULE_5__["Highlight"](range, className, data, attributes);
  ...
  underline(cfiRange, data = {}, cb, className = "epubjs-ul", styles = {}) {
    ...
    let m = new _victorsoares96_marks_pane__WEBPACK_IMPORTED_MODULE_5__["Underline"](range, className, data, attributes);
    let h = this.pane.addMark(m);
  ...
  mark(cfiRange, data = {}, cb, className = "epubjs-mk", styles = {}) {
    ...
    if (cb) {
      mark.addEventListener("click", cb); // mark.addEventListener("touchstart", cb);
    }

    mark.addEventListener("click", emitter); // mark.addEventListener("touchstart", emitter);
...
class navigation_Navigation {
  constructor(xml, navPath = "") {
    ...
    if (navPath) {
      this.tocPath = new utils_path["a" /* default */](navPath);
    }
...
var external_JSZip_ = __webpack_require__(76);
...
var conventions = __webpack_require__(26);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _book__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(49);
...
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1);
/* harmony import */ var _managers_views_iframe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(45);
/* harmony import */ var _managers_default__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16);
/* harmony import */ var _managers_continuous__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(47);
...
var sax = __webpack_require__(95);
...
var freeze = __webpack_require__(26).freeze;
...
var aCallable = __webpack_require__(102);
...
var baseTrim = __webpack_require__(132),
    isObject = __webpack_require__(44),
...
var trimmedEndIndex = __webpack_require__(133);
